function openerp_pos_models(instance, module){ //module is instance.point_of_sale
        ...
        models: [
        {
            ...
            loaded: function(self, currencies){
                ...
                _.each(currencies, function(curr){
                    if (curr.id === 3){
                        console.log('a',curr.rate_silent);
                    }
                }),
            ...
            fields: ['account_id','currency','currency1','journal_id','state','name','user_id','pos_session_id'],
    ...
    module.Order = Backbone.Model.extend({
        initialize: function(attributes){
            ...
            this.all_currency =  attributes.pos.all_currency;
            this.set({
        ...
        addPaymentline: function(cashregister) {
            ...
            if(cashregister.journal.type !== 'cash'){
                newPaymentline.set_amount( Math.max(this.getDueLeft(),0), 1);
            }
        ...
        getCurrentCurrency: function(){
            var a = this.pos.all_currency;
            return (this.get('paymentLines')).reduce((function(currency_id, paymentLine) {
               var curr_id = paymentLine.cashregister.currency[0];
               var rate = 1.0;
               _.each(a, function(curr){
                    if(curr.id === curr_id){
                        rate = curr.rate_silent;
                        currency_id =  curr.id;
                    }
                })
        ...
        getPaidTotal: function() {
            ...
            return (this.get('paymentLines')).reduce((function(sum, paymentLine) {
               ...
               sum = sum + round_di(parseFloat(parseFloat(paymentLine.get_amount()) / rate) || 0, 2);
               return sum;
            }), 0);
        },
        getChange: function() {
